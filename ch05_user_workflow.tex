...
On load, modules try to restore their activation state; if a hardware module cannot activate (robot/camera unavailable), loading may fail and restore only part of the setup.
