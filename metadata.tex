...
The prototype demonstrates that this approach can support selected task-oriented workflows, with seam welding showing the clearest practical fit because authored trajectory input is used to identify and parameterize the weld seam, while pick-and-place shows that authored intent can be combined with refreshed scene information at execution time.
}
...
Výsledky ukazují, že tento přístup může podporovat vybrané úlohově orientované pracovní postupy.
