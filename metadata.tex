...
Výsledkem je kvalitativní ověření, že tento přístup může podpořit vybrané úlohově orientované pracovní postupy.
...
Přínos práce však stále vymezují hranice prototypu, jen omezené ověření na~reálném robotu a~také dosavadní limity detekce scény, robustnosti snímání a~chybějící integrace nástrojů.
}
