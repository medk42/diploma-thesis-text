...
\begin{verbatim}
camera/                  Calibration artifacts (Charuco PDF, camera mount CAD)
diploma-thesis-code/      Pruned C++ source tree (core + helpers + modules)
pen/                     Pen CAD + firmware
robot/aergo_interface_cbun/ Robot-side component (CBun) source tree
scene/                   Example scene CAD model(s)
third_party_licenses/    License texts for vendored components
...
\begin{verbatim}
cmake --list-presets
cmake --preset core-windows    # or: core-linux
cmake --build --preset core-windows-Release   # or: -Debug / core-linux-*
\end{verbatim}
