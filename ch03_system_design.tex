...
\begin{itemize}
    \item \textbf{Data path (\type{const char* data_path}).} Optional filesystem location for module resources; may be \type{nullptr} if no user-provided data directory is available for the module.
